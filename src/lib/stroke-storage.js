/**
 * Stroke Storage Utilities — v2.0
 *
 * Helpers for stroke ID generation, format conversion, bounds calculation,
 * deduplication, and user-facing JSON/MD exports.
 *
 * The v1 LogSeq-specific helpers (chunked storage, block JSON parsing) were
 * removed in v2.0; PageDoc files in `<dataRoot>/pages/B###/P##.json` are the
