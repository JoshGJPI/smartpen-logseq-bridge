...
<style>
  ...
  .stroke-items {
    ...
    background: var(--bg-secondary);
    max-height: 400px; /* Constrain height to allow scrolling within page */
    overflow-y: auto; /* Enable scrolling within the stroke list */
  }
  
  /* Scrollbar styling for stroke items */
